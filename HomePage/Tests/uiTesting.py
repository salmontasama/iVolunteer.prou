...
def test_hero_ui():
    ...
    for top_img, buttom_img, top_p, buttom_p, y, j in zip(top_hero_imgs, buttom_hero_imgs, top_hero_paragraph,
                                                          buttom_hero_paragraph, CO.home_page_hero_top_text,
                                                          CO.home_page_hero_buttom_text):
    ...
    left_hero_col_buttom_text = driver.find_element(By.XPATH,
                                                    "//body/div[@id='root']/div[1]/div[1]/div[2]/div[4]/div["
                                                    "2]/section[1]").text
    right_hero_col_buttom_text = driver.find_element(By.XPATH,
                                                     "//body/div[@id='root']/div[1]/div[1]/div[2]/div[4]/div["
                                                     "1]/section[1]").text
